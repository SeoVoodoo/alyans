...
`,xp="/alyans/assets/images/png-sprite/icons/sprite-min.png";/**
 ...
 *
 * @license MIT
 */function Mn(){return Mn=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var l=arguments[t];for(var r in l)Object.prototype.hasOwnProperty.call(l,r)&&(e[r]=l[r])}return e},Mn.apply(this,arguments)}var tl;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(tl||(tl={}));const Zc="popstate";function uy(e){e===void 0&&(e={});function t(r,n){let{pathname:i,search:o,hash:a}=r.location;return Ja("",{pathname:i,search:o,hash:a},n.state&&n.state.usr||null,n.state&&n.state.key||"default")}function l(r,n){return typeof n=="string"?n:go(n)}return hy(t,l,null,e)}function de(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function wp(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function fy(){return Math.random().toString(36).substr(2,8)}function eu(e,t){return{usr:e.state,key:e.key,idx:t}}function Ja(e,t,l,r){return l===void 0&&(l=null),Mn({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?Lr(t):t,{state:l,key:t&&t.key||r||fy()})}function go(e){let{pathname:t="/",search:l="",hash:r=""}=e;return l&&l!=="?"&&(t+=l.charAt(0)==="?"?l:"?"+l),r&&r!=="#"&&(t+=r.charAt(0)==="#"?r:"#"+r),t}function Lr(e){let t={};if(e){let l=e.indexOf("#");l>=0&&(t.hash=e.substr(l),e=e.substr(0,l));let r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function hy(e,t,l,r){r===void 0&&(r={});let{window:n=document.defaultView,v5Compat:i=!1}=r,o=n.history,a=tl.Pop,s=null,c=u();c==null&&(c=0,o.replaceState(Mn({},o.state,{idx:c}),""));function u(){return(o.state||{idx:null}).idx}function f(){a=tl.Pop;let w=u(),g=w==null?null:w-c;c=w,s&&s({action:a,location:x.location,delta:g})}function m(w,g){a=tl.Push;let h=Ja(x.location,w,g);c=u()+1;let p=eu(h,c),v=x.createHref(h);try{o.pushState(p,"",v)}catch(b){if(b instanceof DOMException&&b.name==="DataCloneError")throw b;n.location.assign(v)}i&&s&&s({action:a,location:x.location,delta:1})}function y(w,g){a=tl.Replace;let h=Ja(x.location,w,g);c=u();let p=eu(h,c),v=x.createHref(h);o.replaceState(p,"",v),i&&s&&s({action:a,location:x.location,delta:0})}function C(w){let g=n.location.origin!=="null"?n.location.origin:n.location.href,h=typeof w=="string"?w:go(w);return h=h.replace(/ $/,"%20"),de(g,"No window.location.(origin|href) available to create URL for href: "+h),new URL(h,g)}let x={get action(){return a},get location(){return e(n,o)},listen(w){if(s)throw new Error("A history only accepts one active listener");return n.addEventListener(Zc,f),s=w,()=>{n.removeEventListener(Zc,f),s=null}},createHref(w){return t(n,w)},createURL:C,encodeLocation(w){let g=C(w);return{pathname:g.pathname,search:g.search,hash:g.hash}},push:m,replace:y,go(w){return o.go(w)}};return x}var tu;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(tu||(tu={}));function py(e,t,l){return l===void 0&&(l="/"),my(e,t,l,!1)}function my(e,t,l,r){let n=typeof t=="string"?Lr(t):t,i=Pr(n.pathname||"/",l);if(i==null)return null;let o=bp(e);gy(o);let a=null;for(let s=0;a==null&&s<o.length;++s){let c=Ay(i);a=Ty(o[s],c,r)}return a}function bp(e,t,l,r){t===void 0&&(t=[]),l===void 0&&(l=[]),r===void 0&&(r="");let n=(i,o,a)=>{let s={relativePath:a===void 0?i.path||"":a,caseSensitive:i.caseSensitive===!0,childrenIndex:o,route:i};s.relativePath.startsWith("/")&&(de(s.relativePath.startsWith(r),'Absolute route path "'+s.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),s.relativePath=s.relativePath.slice(r.length));let c=hl([r,s.relativePath]),u=l.concat(s);i.children&&i.children.length>0&&(de(i.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+c+'".')),bp(i.children,t,u,c)),!(i.path==null&&!i.index)&&t.push({path:c,score:Sy(c,i.index),routesMeta:u})};return e.forEach((i,o)=>{var a;if(i.path===""||!((a=i.path)!=null&&a.includes("?")))n(i,o);else for(let s of Sp(i.path))n(i,o,s)}),t}function Sp(e){let t=e.split("/");if(t.length===0)return[];let[l,...r]=t,n=l.endsWith("?"),i=l.replace(/\?$/,"");if(r.length===0)return n?[i,""]:[i];let o=Sp(r.join("/")),a=[];return a.push(...o.map(s=>s===""?i:[i,s].join("/"))),n&&a.push(...o),a.map(s=>e.startsWith("/")&&s===""?"/":s)}function gy(e){e.sort((t,l)=>t.score!==l.score?l.score-t.score:ky(t.routesMeta.map(r=>r.childrenIndex),l.routesMeta.map(r=>r.childrenIndex)))}const Cy=/^:[\w-]+$/,yy=3,vy=2,xy=1,wy=10,by=-2,lu=e=>e==="*";function Sy(e,t){let l=e.split("/"),r=l.length;return l.some(lu)&&(r+=by),t&&(r+=vy),l.filter(n=>!lu(n)).reduce((n,i)=>n+(Cy.test(i)?yy:i===""?xy:wy),r)}function ky(e,t){return e.length===t.length&&e.slice(0,-1).every((r,n)=>r===t[n])?e[e.length-1]-t[t.length-1]:0}function Ty(e,t,l){let{routesMeta:r}=e,n={},i="/",o=[];for(let a=0;a<r.length;++a){let s=r[a],c=a===r.length-1,u=i==="/"?t:t.slice(i.length)||"/",f=Co({path:s.relativePath,caseSensitive:s.caseSensitive,end:c},u),m=s.route;if(!f&&c&&l&&!r[r.length-1].route.index&&(f=Co({path:s.relativePath,caseSensitive:s.caseSensitive,end:!1},u)),!f)return null;Object.assign(n,f.params),o.push({params:n,pathname:hl([i,f.pathname]),pathnameBase:jy(hl([i,f.pathnameBase])),route:m}),f.pathnameBase!=="/"&&(i=hl([i,f.pathnameBase]))}return o}function Co(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[l,r]=Ey(e.path,e.caseSensitive,e.end),n=t.match(l);if(!n)return null;let i=n[0],o=i.replace(/(.)\/+$/,"$1"),a=n.slice(1);return{params:r.reduce((c,u,f)=>{let{paramName:m,isOptional:y}=u;if(m==="*"){let x=a[f]||"";o=i.slice(0,i.length-x.length).replace(/(.)\/+$/,"$1")}const C=a[f];return y&&!C?c[m]=void 0:c[m]=(C||"").replace(/%2F/g,"/"),c},{}),pathname:i,pathnameBase:o,pattern:e}}function Ey(e,t,l){t===void 0&&(t=!1),l===void 0&&(l=!0),wp(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let r=[],n="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(o,a,s)=>(r.push({paramName:a,isOptional:s!=null}),s?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(r.push({paramName:"*"}),n+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):l?n+="\\/*$":e!==""&&e!=="/"&&(n+="(?:(?=\\/|$))"),[new RegExp(n,t?void 0:"i"),r]}function Ay(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return wp(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function Pr(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let l=t.endsWith("/")?t.length-1:t.length,r=e.charAt(l);return r&&r!=="/"?null:e.slice(l)||"/"}function Py(e,t){t===void 0&&(t="/");let{pathname:l,search:r="",hash:n=""}=typeof e=="string"?Lr(e):e;return{pathname:l?l.startsWith("/")?l:$y(l,t):t,search:_y(r),hash:zy(n)}}function $y(e,t){let l=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(n=>{n===".."?l.length>1&&l.pop():n!=="."&&l.push(n)}),l.length>1?l.join("/"):"/"}function Ns(e,t,l,r){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+l+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Iy(e){return e.filter((t,l)=>l===0||t.route.path&&t.route.path.length>0)}function kp(e,t){let l=Iy(e);return t?l.map((r,n)=>n===l.length-1?r.pathname:r.pathnameBase):l.map(r=>r.pathnameBase)}function Tp(e,t,l,r){r===void 0&&(r=!1);let n;typeof e=="string"?n=Lr(e):(n=Mn({},e),de(!n.pathname||!n.pathname.includes("?"),Ns("?","pathname","search",n)),de(!n.pathname||!n.pathname.includes("#"),Ns("#","pathname","hash",n)),de(!n.search||!n.search.includes("#"),Ns("#","search","hash",n)));let i=e===""||n.pathname==="",o=i?"/":n.pathname,a;if(o==null)a=l;else{let f=t.length-1;if(!r&&o.startsWith("..")){let m=o.split("/");for(;m[0]==="..";)m.shift(),f-=1;n.pathname=m.join("/")}a=f>=0?t[f]:"/"}let s=Py(n,a),c=o&&o!=="/"&&o.endsWith("/"),u=(i||o===".")&&l.endsWith("/");return!s.pathname.endsWith("/")&&(c||u)&&(s.pathname+="/"),s}const hl=e=>e.join("/").replace(/\/\/+/g,"/"),jy=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),_y=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,zy=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function Ly(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const Ep=["post","put","patch","delete"];new Set(Ep);const My=["get",...Ep];new Set(My);/**
 ...
 *
 * @license MIT
 */function Rn(){return Rn=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var l=arguments[t];for(var r in l)Object.prototype.hasOwnProperty.call(l,r)&&(e[r]=l[r])}return e},Rn.apply(this,arguments)}const Ko=$.createContext(null),Ap=$.createContext(null),wl=$.createContext(null),Xo=$.createContext(null),Ul=$.createContext({outlet:null,matches:[],isDataRoute:!1}),Pp=$.createContext(null);function Ry(e,t){let{relative:l}=t===void 0?{}:t;Vn()||de(!1);let{basename:r,navigator:n}=$.useContext(wl),{hash:i,pathname:o,search:a}=Qo(e,{relative:l}),s=o;return r!=="/"&&(s=o==="/"?r:hl([r,o])),n.createHref({pathname:s,search:a,hash:i})}function Vn(){return $.useContext(Xo)!=null}function Mr(){return Vn()||de(!1),$.useContext(Xo).location}function $p(e){$.useContext(wl).static||$.useLayoutEffect(e)}function Ny(){let{isDataRoute:e}=$.useContext(Ul);return e?Xy():Oy()}function Oy(){Vn()||de(!1);let e=$.useContext(Ko),{basename:t,future:l,navigator:r}=$.useContext(wl),{matches:n}=$.useContext(Ul),{pathname:i}=Mr(),o=JSON.stringify(kp(n,l.v7_relativeSplatPath)),a=$.useRef(!1);return $p(()=>{a.current=!0}),$.useCallback(function(c,u){if(u===void 0&&(u={}),!a.current)return;if(typeof c=="number"){r.go(c);return}let f=Tp(c,JSON.parse(o),i,u.relative==="path");e==null&&t!=="/"&&(f.pathname=f.pathname==="/"?t:hl([t,f.pathname])),(u.replace?r.replace:r.push)(f,u.state,u)},[t,r,o,i,e])}function Qo(e,t){let{relative:l}=t===void 0?{}:t,{future:r}=$.useContext(wl),{matches:n}=$.useContext(Ul),{pathname:i}=Mr(),o=JSON.stringify(kp(n,r.v7_relativeSplatPath));return $.useMemo(()=>Tp(e,JSON.parse(o),i,l==="path"),[e,o,i,l])}function By(e,t){return Dy(e,t)}function Dy(e,t,l,r){Vn()||de(!1);let{navigator:n}=$.useContext(wl),{matches:i}=$.useContext(Ul),o=i[i.length-1],a=o?o.params:{};o&&o.pathname;let s=o?o.pathnameBase:"/";o&&o.route;let c=Mr(),u;if(t){var f;let w=typeof t=="string"?Lr(t):t;s==="/"||(f=w.pathname)!=null&&f.startsWith(s)||de(!1),u=w}else u=c;let m=u.pathname||"/",y=m;if(s!=="/"){let w=s.replace(/^\//,"").split("/");y="/"+m.replace(/^\//,"").split("/").slice(w.length).join("/")}let C=py(e,{pathname:y}),x=Uy(C&&C.map(w=>Object.assign({},w,{params:Object.assign({},a,w.params),pathname:hl([s,n.encodeLocation?n.encodeLocation(w.pathname).pathname:w.pathname]),pathnameBase:w.pathnameBase==="/"?s:hl([s,n.encodeLocation?n.encodeLocation(w.pathnameBase).pathname:w.pathnameBase])})),i,l,r);return t&&x?$.createElement(Xo.Provider,{value:{location:Rn({pathname:"/",search:"",hash:"",state:null,key:"default"},u),navigationType:tl.Pop}},x):x}function Fy(){let e=Ky(),t=Ly(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),l=e instanceof Error?e.stack:null,n={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return $.createElement($.Fragment,null,$.createElement("h2",null,"Unexpected Application Error!"),$.createElement("h3",{style:{fontStyle:"italic"}},t),l?$.createElement("pre",{style:n},l):null,null)}const Wy=$.createElement(Fy,null);class Vy extends $.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,l){return l.location!==t.location||l.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:l.error,location:l.location,revalidation:t.revalidation||l.revalidation}}componentDidCatch(t,l){console.error("React Router caught the following error during render",t,l)}render(){return this.state.error!==void 0?$.createElement(Ul.Provider,{value:this.props.routeContext},$.createElement(Pp.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function Hy(e){let{routeContext:t,match:l,children:r}=e,n=$.useContext(Ko);return n&&n.static&&n.staticContext&&(l.route.errorElement||l.route.ErrorBoundary)&&(n.staticContext._deepestRenderedBoundaryId=l.route.id),$.createElement(Ul.Provider,{value:t},r)}function Uy(e,t,l,r){var n;if(t===void 0&&(t=[]),l===void 0&&(l=null),r===void 0&&(r=null),e==null){var i;if(!l)return null;if(l.errors)e=l.matches;else if((i=r)!=null&&i.v7_partialHydration&&t.length===0&&!l.initialized&&l.matches.length>0)e=l.matches;else return null}let o=e,a=(n=l)==null?void 0:n.errors;if(a!=null){let u=o.findIndex(f=>f.route.id&&(a==null?void 0:a[f.route.id])!==void 0);u>=0||de(!1),o=o.slice(0,Math.min(o.length,u+1))}let s=!1,c=-1;if(l&&r&&r.v7_partialHydration)for(let u=0;u<o.length;u++){let f=o[u];if((f.route.HydrateFallback||f.route.hydrateFallbackElement)&&(c=u),f.route.id){let{loaderData:m,errors:y}=l,C=f.route.loader&&m[f.route.id]===void 0&&(!y||y[f.route.id]===void 0);if(f.route.lazy||C){s=!0,c>=0?o=o.slice(0,c+1):o=[o[0]];break}}}return o.reduceRight((u,f,m)=>{let y,C=!1,x=null,w=null;l&&(y=a&&f.route.id?a[f.route.id]:void 0,x=f.route.errorElement||Wy,s&&(c<0&&m===0?(C=!0,w=null):c===m&&(C=!0,w=f.route.hydrateFallbackElement||null)));let g=t.concat(o.slice(0,m+1)),h=()=>{let p;return y?p=x:C?p=w:f.route.Component?p=$.createElement(f.route.Component,null):f.route.element?p=f.route.element:p=u,$.createElement(Hy,{match:f,routeContext:{outlet:u,matches:g,isDataRoute:l!=null},children:p})};return l&&(f.route.ErrorBoundary||f.route.errorElement||m===0)?$.createElement(Vy,{location:l.location,revalidation:l.revalidation,component:x,error:y,children:h(),routeContext:{outlet:null,matches:g,isDataRoute:!0}}):h()},null)}var Ip=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Ip||{}),yo=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(yo||{});function Gy(e){let t=$.useContext(Ko);return t||de(!1),t}function qy(e){let t=$.useContext(Ap);return t||de(!1),t}function Yy(e){let t=$.useContext(Ul);return t||de(!1),t}function jp(e){let t=Yy(),l=t.matches[t.matches.length-1];return l.route.id||de(!1),l.route.id}function Ky(){var e;let t=$.useContext(Pp),l=qy(yo.UseRouteError),r=jp(yo.UseRouteError);return t!==void 0?t:(e=l.errors)==null?void 0:e[r]}function Xy(){let{router:e}=Gy(Ip.UseNavigateStable),t=jp(yo.UseNavigateStable),l=$.useRef(!1);return $p(()=>{l.current=!0}),$.useCallback(function(n,i){i===void 0&&(i={}),l.current&&(typeof n=="number"?e.navigate(n):e.navigate(n,Rn({fromRouteId:t},i)))},[e,t])}function ge(e){de(!1)}function Qy(e){let{basename:t="/",children:l=null,location:r,navigationType:n=tl.Pop,navigator:i,static:o=!1,future:a}=e;Vn()&&de(!1);let s=t.replace(/^\/*/,"/"),c=$.useMemo(()=>({basename:s,navigator:i,static:o,future:Rn({v7_relativeSplatPath:!1},a)}),[s,a,i,o]);typeof r=="string"&&(r=Lr(r));let{pathname:u="/",search:f="",hash:m="",state:y=null,key:C="default"}=r,x=$.useMemo(()=>{let w=Pr(u,s);return w==null?null:{location:{pathname:w,search:f,hash:m,state:y,key:C},navigationType:n}},[s,u,f,m,y,C,n]);return x==null?null:$.createElement(wl.Provider,{value:c},$.createElement(Xo.Provider,{children:l,value:x}))}function Jy(e){let{children:t,location:l}=e;return By(Za(t),l)}new Promise(()=>{});function Za(e,t){t===void 0&&(t=[]);let l=[];return $.Children.forEach(e,(r,n)=>{if(!$.isValidElement(r))return;let i=[...t,n];if(r.type===$.Fragment){l.push.apply(l,Za(r.props.children,i));return}r.type!==ge&&de(!1),!r.props.index||!r.props.children||de(!1);let o={id:r.props.id||i.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(o.children=Za(r.props.children,i)),l.push(o)}),l}/**
 ...
 *
 * @license MIT
 */function vo(){return vo=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var l=arguments[t];for(var r in l)Object.prototype.hasOwnProperty.call(l,r)&&(e[r]=l[r])}return e},vo.apply(this,arguments)}function _p(e,t){if(e==null)return{};var l={},r=Object.keys(e),n,i;for(i=0;i<r.length;i++)n=r[i],!(t.indexOf(n)>=0)&&(l[n]=e[n]);return l}function Zy(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function ev(e,t){return e.button===0&&(!t||t==="_self")&&!Zy(e)}const tv=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],lv=["aria-current","caseSensitive","className","end","style","to","unstable_viewTransition","children"],rv="6";try{window.__reactRouterVersion=rv}catch{}const nv=$.createContext({isTransitioning:!1}),iv="startTransition",ru=Y1[iv];function ov(e){let{basename:t,children:l,future:r,window:n}=e,i=$.useRef();i.current==null&&(i.current=uy({window:n,v5Compat:!0}));let o=i.current,[a,s]=$.useState({action:o.action,location:o.location}),{v7_startTransition:c}=r||{},u=$.useCallback(f=>{c&&ru?ru(()=>s(f)):s(f)},[s,c]);return $.useLayoutEffect(()=>o.listen(u),[o,u]),$.createElement(Qy,{basename:t,children:l,location:a.location,navigationType:a.action,navigator:o,future:r})}const sv=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",av=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Pe=$.forwardRef(function(t,l){let{onClick:r,relative:n,reloadDocument:i,replace:o,state:a,target:s,to:c,preventScrollReset:u,unstable_viewTransition:f}=t,m=_p(t,tv),{basename:y}=$.useContext(wl),C,x=!1;if(typeof c=="string"&&av.test(c)&&(C=c,sv))try{let p=new URL(window.location.href),v=c.startsWith("//")?new URL(p.protocol+c):new URL(c),b=Pr(v.pathname,y);v.origin===p.origin&&b!=null?c=b+v.search+v.hash:x=!0}catch{}let w=Ry(c,{relative:n}),g=cv(c,{replace:o,state:a,target:s,preventScrollReset:u,relative:n,unstable_viewTransition:f});function h(p){r&&r(p),p.defaultPrevented||g(p)}return $.createElement("a",vo({},m,{href:C||w,onClick:x||i?r:h,ref:l,target:s}))}),rn=$.forwardRef(function(t,l){let{"aria-current":r="page",caseSensitive:n=!1,className:i="",end:o=!1,style:a,to:s,unstable_viewTransition:c,children:u}=t,f=_p(t,lv),m=Qo(s,{relative:f.relative}),y=Mr(),C=$.useContext(Ap),{navigator:x,basename:w}=$.useContext(wl),g=C!=null&&uv(m)&&c===!0,h=x.encodeLocation?x.encodeLocation(m).pathname:m.pathname,p=y.pathname,v=C&&C.navigation&&C.navigation.location?C.navigation.location.pathname:null;n||(p=p.toLowerCase(),v=v?v.toLowerCase():null,h=h.toLowerCase()),v&&w&&(v=Pr(v,w)||v);const b=h!=="/"&&h.endsWith("/")?h.length-1:h.length;let k=p===h||!o&&p.startsWith(h)&&p.charAt(b)==="/",E=v!=null&&(v===h||!o&&v.startsWith(h)&&v.charAt(h.length)==="/"),I={isActive:k,isPending:E,isTransitioning:g},A=k?r:void 0,T;typeof i=="function"?T=i(I):T=[i,k?"active":null,E?"pending":null,g?"transitioning":null].filter(Boolean).join(" ");let j=typeof a=="function"?a(I):a;return $.createElement(Pe,vo({},f,{"aria-current":A,className:T,ref:l,style:j,to:s,unstable_viewTransition:c}),typeof u=="function"?u(I):u)});var e0;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(e0||(e0={}));var nu;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(nu||(nu={}));function dv(e){let t=$.useContext(Ko);return t||de(!1),t}function cv(e,t){let{target:l,replace:r,state:n,preventScrollReset:i,relative:o,unstable_viewTransition:a}=t===void 0?{}:t,s=Ny(),c=Mr(),u=Qo(e,{relative:o});return $.useCallback(f=>{if(ev(f,l)){f.preventDefault();let m=r!==void 0?r:go(c)===go(u);s(e,{replace:m,state:n,preventScrollReset:i,relative:o,unstable_viewTransition:a})}},[c,s,u,r,n,l,e,i,o,a])}function uv(e,t){t===void 0&&(t={});let l=$.useContext(nv);l==null&&de(!1);let{basename:r}=dv(e0.useViewTransitionState),n=Qo(e,{relative:t.relative});if(!l.isTransitioning)return!1;let i=Pr(l.currentLocation.pathname,r)||l.currentLocation.pathname,o=Pr(l.nextLocation.pathname,r)||l.nextLocation.pathname;return Co(n.pathname,o)!=null||Co(n.pathname,i)!=null}const hd=e=>d.jsx(fv,{head:e.head,children:d.jsx(Pe,{to:"/",children:d.jsx(hv,{head:e.head})})}),fv=S.div`
    grid-area: logo;
...
`,pv="/alyans/assets/images/svg-sprite/icons-sprite.svg",Tt=e=>d.jsx("svg",{width:e.width||"50",className:e.className||"",height:e.height||"50",viewBox:e.viewBox||"0 0 50 50",fill:e.fill||"none",stroke:e.stroke||"none",xmlns:"http://www.w3.org/2000/svg",children:d.jsx("use",{xlinkHref:`${pv}#${e.id}`})}),mv=e=>{const[t,l]=$.useState(!1),r=()=>{l(n=>!n)};return d.jsx(gv,{children:d.jsx("form",{role:"search",method:"get",action:"",children:d.jsxs(Cv,{children:[d.jsx(vv,{onMouseEnter:r,onMouseLeave:r,type:"button",children:d.jsx(Tt,{id:"search",width:e.windowWidth>767?"24":"20",height:e.windowWidth>767?"24":"20",viewBox:(e.windowWidth>767,"0 0 24 24"),fill:t?"#1D1F24":"#6b6b6b"})}),d.jsx(yv,{type:"search",name:"search-text",placeholder:"Поиск по сайту"})]})})})},gv=S.div`
    /* grid-area: search;
    justify-self: center;    
    max-width: 506px;
    width: 100%;      */
...
`,xv=()=>{const e=zr(),[t,l]=$.useState(!1);function r(){l(n=>!n)}return d.jsx(wv,{children:d.jsxs(bv,{isPush:t,children:[d.jsx(Sv,{onClick:r,type:"button",children:d.jsx(Tt,{id:"search",width:"18",height:"18",viewBox:"0 -1 24 24",fill:e.color.searchIcon})}),d.jsx(kv,{role:"search",method:"get",action:"",children:d.jsx(Tv,{type:"search",name:"search-text",placeholder:"Поиск по сайту",isPush:t})})]})})},wv=S.div`
    //position: relative;        
`,bv=S.div`        
    /* position: absolute; */
    /* top: 50%;
...
`,zp=e=>d.jsx(Ev,{children:e.windowWidth>576?d.jsx(mv,{windowWidth:e.windowWidth}):d.jsx(xv,{})}),Ev=S.div`
    max-width: 506px;
    @media ${({theme:e})=>e.media.lg992} {
      max-width: 360px;  
      margin-left: 12px;
...
`,Jo=e=>{const t=zr();return d.jsx(Av,{fontSize:e.fontSize,children:e.socials.map((l,r)=>d.jsx(Pv,{href:l.link,children:d.jsx(Tt,{id:l.id,width:e.width,height:e.height,viewBox:"0 0 40 40",fill:e.themeName!=="default"?t.color.outline:l.id==="classmates"?"#F96600":l.id==="telegram"?"#1C8ADB":l.id==="viber"?"#6F3FAA":"#2787F5",stroke:e.themeName==="dark"?"black":"none"})},r))})},Av=S.div`
    grid-area: social;
    padding-top: 15px;
    display: flex;
    align-items: center;
...
`,Lp=e=>{const t=zr(),l=992;return d.jsx($v,{onClick:e.handleVisuallyImpairedPanel,children:e.isShowVisuallyImpairedPanel?d.jsxs(d.Fragment,{children:[d.jsx(Tt,{id:"eye-off",width:"24",height:"24",viewBox:"0 0 48 48",fill:t.color.defaultText,className:"icon"}),e.windowWidth>l?"Обычная версия сайта":""]}):d.jsxs(d.Fragment,{children:[d.jsx(Tt,{id:"eye",width:"24",height:"16",viewBox:"0 0 24 16",fill:t.color.defaultText,className:"icon"}),e.windowWidth>l?"Версия для слабовидящих":""]})})},$v=S.button`
    ...
    //     color: ${({theme:e})=>e.color.defaultTextHover}; 
    // }
`,Mp=e=>d.jsxs(Iv,{children:[d.jsxs(iu,{children:[e.windowWidth>e.breakpoint?d.jsx("span",{children:"Размер шрифта:"}):d.jsxs("span",{children:["Размер",d.jsx("br",{}),"шрифта:"]}),d.jsx(Kr,{type:"button",name:"decrease",onClick:e.handleFontSize,children:"А-"}),d.jsx(Kr,{type:"button",name:"add",onClick:e.handleFontSize,children:"А+"})]}),d.jsxs(iu,{children:[e.windowWidth>e.breakpoint?d.jsx("span",{children:"Цвет сайта:"}):d.jsxs("span",{children:["Цвет",d.jsx("br",{}),"сайта:"]}),d.jsx(Kr,{onClick:e.handleToggleTheme,name:"light",type:"button",children:"А"}),d.jsx(Kr,{onClick:e.handleToggleTheme,name:"dark",type:"button",children:"А"}),d.jsx(Kr,{onClick:e.handleToggleTheme,name:"blue",type:"button",children:"А"})]})]}),Iv=S.div`
    height: 58px;
    width: max-content; 
    margin: 0 auto;
    padding: 10px 0;
...
`,Gl=e=>d.jsx(jv,{children:d.jsx(_v,{top:e.top,right:e.right,left:e.left,onClick:e.handleToggleModalWindow||e.handleToggleSidebar||e.handleCloseMobileModalWindowMenu||e.handleCloseMobileModalWindowContact})}),jv=S.div`    
    width: 100%;
    position: relative;    
`,_v=S.button`
    position: absolute;
...
`,md=e=>{const t=zr(),l=767,r=n=>n.replace(/\D/g,"");return d.jsxs(zv,{children:[d.jsxs(ou,{children:[d.jsx(Tt,{id:"phone",width:"20",height:"20",viewBox:"0 0 20 20",fill:t.color.fillContactIcon}),e.windowWidth>l?e.contacts.phone1:d.jsx("a",{href:`tel:${r(e.contacts.phone1)}`,children:e.contacts.phone1})]}),d.jsx(Lv,{children:"(многоканальный)"}),d.jsxs(ou,{children:[d.jsx(Tt,{id:"phone",width:"20",height:"20",viewBox:"0 0 20 20",fill:t.color.fillContactIcon}),e.windowWidth>l?e.contacts.phone2:d.jsx("a",{href:`tel:${r(e.contacts.phone2)}`,children:e.contacts.phone2})]}),d.jsxs(Mv,{href:`mailto:${e.contacts.email}`,children:[d.jsx(Tt,{id:"email",width:"20",height:"20",viewBox:"0 0 20 20",fill:t.color.fillContactIcon}),e.contacts.email]}),e.contacts.callback&&e.handleToggleModalWindow&&d.jsx(Rv,{onClick:()=>{var n;return(n=e.handleToggleModalWindow)==null?void 0:n.call(e,"callback")},children:"Заказать звонок"})]})},zv=S.div`
    grid-area: contact;    
    display: flex;
...
`,Nv=e=>d.jsxs(Ov,{isOpen:e.isOpen,children:[d.jsx(Gl,{handleCloseMobileModalWindowContact:e.handleCloseMobileModalWindowContact,top:"-20vh",right:"0"}),d.jsx(J,{children:"Связаться с нами"}),d.jsx(Et,{onClick:()=>e.handleToggleModalWindow("record"),children:"Запись на прием"}),d.jsx(Xe,{onClick:()=>e.handleToggleModalWindow("callback"),children:"Заказать обратный звонок"}),d.jsx(Jo,{themeName:e.themeName,socials:e.socials,width:"60",height:"60"}),d.jsx(md,{themeName:e.themeName,contacts:e.contacts,windowWidth:e.windowWidth})]}),Ov=S.div`  
    display: flex;
    flex-direction: column;
...
`,mn="/alyans/assets/images/png-sprite/counter/sprite_counter-min.png",Bv=xl`
...
`,gd=e=>{const t=String(e.counter.girls+e.counter.boys);return d.jsxs(Vv,{fontSize:e.fontSize,children:[d.jsxs(Hv,{children:[d.jsx("span",{children:"Наши детки"}),d.jsxs(Uv,{children:[d.jsx(Gv,{}),d.jsxs(qv,{children:[d.jsx("span",{children:t[0]}),d.jsx("span",{children:t[1]}),d.jsx("span",{children:t[2]}),d.jsx("span",{children:t[3]})]})]})]}),d.jsxs(Yv,{children:[d.jsx("span",{children:"Девочки"}),d.jsx("span",{children:e.counter.girls})]}),d.jsx(Kv,{}),d.jsxs(Xv,{children:[d.jsx("span",{children:"Мальчики"}),d.jsx("span",{children:e.counter.boys})]})]})},Vv=S.div`
...
`,Uv=S.div`
    ...
    &::before {
        ...
        left: 10px;
        z-index: 10;
        animation: ${Bv} 7s cubic-bezier(0.4, 0.51, 0.52, 0.57) infinite;
    }
    ...
    &::after {
        ...
        right: 0;
        z-index: 10;
        animation: ${Dv} 7s cubic-bezier(0.4, 0.51, 0.52, 0.57) infinite;
    }   
...
`,Gv=S.div`    
    ...
    left: 30px;
    z-index: 10;
    animation:  ${Fv} 2s ease-in-out infinite;
...
`,Kv=S.div`
    ...
    animation: ${Wv} 3s cubic-bezier(0.4, 0, 0.2, 1) 8;
...
`,Qv=e=>{const[t,l]=$.useState(!1);function r(){l(u=>!u)}function n(u,f){u.preventDefault(),e.setIsActiveId(f),l(m=>!m)}const i=e.sidebar.sidebarMenu.entities.pages[e.id],{title:o,path:a,level:s}=i,c="pages"in i?i.pages:null;return d.jsxs(Jv,{isOpen:t,level:s,pages:c,descktop:e.descktop,mobile:e.mobile,children:[d.jsxs(Zv,{children:[d.jsx(Pe,{to:`/${a}`,onClick:u=>n(u,e.id),children:o}),c&&d.jsx(e2,{isOpen:t,onClick:()=>r(),children:"Свернуть/развернуть"})]}),t&&c&&d.jsx(Cd,{sidebar:e.sidebar,ids:c,isActiveId:e.isActiveId,setIsActiveId:e.setIsActiveId})]})},Jv=S.li`
...
`,Cd=e=>d.jsx(t2,{descktop:e.descktop,children:e.ids.map(t=>d.jsx(Qv,{id:t,isActiveId:e.isActiveId,setIsActiveId:e.setIsActiveId,sidebar:e.sidebar,mobile:e.mobile,descktop:e.descktop},t))}),t2=S.ul`
...
`,p2=e=>d.jsxs(m2,{children:[d.jsx(Mp,{handleToggleTheme:e.handleToggleTheme,handleFontSize:e.handleFontSize,breakpoint:e.breakpoint,windowWidth:e.windowWidth}),d.jsx(g2,{children:d.jsxs(ae,{children:[d.jsx(Lp,{handleVisuallyImpairedPanel:e.handleVisuallyImpairedPanel,isShowVisuallyImpairedPanel:e.visuallyImpairedPanel.show,breakpoint:e.breakpoint,windowWidth:e.windowWidth}),d.jsxs(C2,{children:[d.jsx(Et,{onClick:()=>e.handleToggleModalWindow("3ndfl"),children:"Возврат 13%"}),d.jsx(Et,{onClick:()=>e.handleToggleModalWindow("record"),children:"Запись на прием"}),d.jsx(Xe,{onClick:()=>e.handleToggleModalWindow("callback"),children:e.windowWidth>992?"Заказать обратный звонок":"Заказать звонок"}),d.jsx(t0,{handleBurgerBtnClick:e.handleBurgerBtnClick}),d.jsx(Op,{isOpen:e.isOpenMenu,handleCloseModalWindowMenu:e.handleCloseModalWindowMenu,counter:e.counter,handleToggleModalWindow:e.handleToggleModalWindow,sidebar:e.sidebar,isActiveId:e.isActiveId,setIsActiveId:e.setIsActiveId})]})]})}),d.jsx(y2,{fontSize:e.fontSize,children:d.jsxs(ae,{children:[d.jsx(hd,{head:!0}),d.jsx(gd,{counter:e.counter,fontSize:e.fontSize}),d.jsx(zp,{windowWidth:e.windowWidth}),d.jsx(Jo,{themeName:e.themeName,socials:e.socials,width:e.windowWidth>992?"40":"30",height:e.windowWidth>992?"40":"30",fontSize:e.fontSize}),d.jsx(md,{themeName:e.themeName,contacts:e.contacts,windowWidth:e.windowWidth})]})}),d.jsx(v2,{children:d.jsx(ae,{children:d.jsx(d2,{mainMenu:e.mainMenu,subMenu:e.subMenu,handleToggleSidebar:e.handleToggleSidebar})})})]}),m2=S.div` 
...
`,gb=S.div`    
    ...
    color: ${({theme:e})=>e.color.defaultText};
    font-size: calc((100vw - 26rem)/(137 - 26) * (1 - 0.86) + 0.86rem);
`,Cb=e=>d.jsxs(yb,{children:[d.jsx(J,{children:"Акции"}),d.jsx(vb,{children:e.promotions.map(t=>d.jsx(db,{promo:t,fontSize:e.fontSize},t.id))})]}),yb=S.section`
...
`,C3=S.div`
  display: flex;
  justify-content: center;   
`,y3=e=>d.jsxs(d.Fragment,{children:[d.jsx(yw,{data:e.homePage.mainSlider,themeName:e.themeName,fontSize:e.fontSize}),d.jsx(v3,{children:d.jsxs(ae,{children:[d.jsx($w,{advantages:e.homePage.advantages,fontSize:e.fontSize}),d.jsx(Cb,{promotions:e.homePage.promotions,fontSize:e.fontSize})]})}),d.jsx(ae,{children:d.jsx(Ow,{services:e.homePage.services})}),d.jsx(x3,{children:d.jsx(ae,{children:d.jsx(sb,{doctors:e.homePage.doctors,fontSize:e.fontSize})})}),d.jsx(w3,{children:d.jsx(ae,{children:d.jsx(Ob,{lastNews:e.homePage.lastNews,fontSize:e.fontSize})})}),d.jsx(ae,{children:d.jsx(nS,{lastReview:e.homePage.lastReview,windowWidth:e.windowWidth})}),d.jsx(b3,{children:d.jsx(ae,{children:d.jsx(eS,{usefulInfo:e.homePage.usefulInfo,fontSize:e.fontSize})})}),d.jsx(ae,{children:d.jsx(lS,{partners:e.homePage.partners})}),d.jsx(r1,{reviewsPage:null,windowWidth:null,dispatch:e.dispatch,hidden:!0})]}),v3=S.div`
  padding-top: 30px;
  margin-top: -5px;
...
`,A3=e=>d.jsxs(P3,{fontSize:e.fontSize,children:[d.jsx(Cu,{children:e.duplicateLinks.slice(0,6).map(t=>d.jsx(yu,{children:d.jsx(Pe,{to:`${t.path}`,children:t.ancor})},t.id))}),d.jsx(Cu,{children:e.duplicateLinks.slice(6).map(t=>d.jsx(yu,{children:d.jsx(Pe,{to:`${t.path}`,children:t.ancor})},t.id))})]}),P3=S.div`
    grid-area: links;
    display: flex;
    column-gap: 38px;
...
`,es="/alyans/assets/images/single-img/desctop/bg_form_3ndfl.svg",Sd=e=>{const{error:t,label:l,name:r}=e;return d.jsx(t5,{error:t,children:d.jsxs("label",{children:[t&&d.jsx(l5,{children:t}),d.jsx("input",{type:"checkbox",name:r}),typeof l=="string"?d.jsx("span",{children:l}):l]})})},t5=S.div`
